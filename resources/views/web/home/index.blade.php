								...
								<form>
									...
									<div class="form-group analysis-cart">
										...
										<div>
											...
											<select class="form-control  show-menu-arrow mb-10"
						...
						<div class="col-lg-9">
							<div class="row lap-area">
								<div class="col-lg-3 col-sm-12">
									<img src="img/logoBorg.png" />
								</div>
								<div class="col-lg-7  col-sm-12">
									<h3>We Always Care For Your Health</h3>
								</div>
								<div class="col-lg-2  col-sm-12">
									<a href="#" class="btn btn-danger btn-lap">Check Out</a>
								</div>
							</div>
							<div class="row analysis-area-data">
								<div class="col-lg-4 col-md-6 mb-10">
									<div class="card text-center">
										<div class="card-header bg-success text-white">20 % Discount</div>
										<div class="card-body">
											<h5 class="card-title">Blood Analysis</h5>
											<p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
											<h5>Price: <span style="text-decoration:line-through">200LE</span>  180LE</h5>
							...
							<div class="row justify-content-center">
								<a href="#" class="btn  btn-danger text-white">Check Out</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row analysis-area">
						<div class="col-lg-3">
							...
							<h4 class="rec-price-title">Recommended Best Prices</h4>
							<div class="row">
								<div class="col-lg-12">
									<div class="single-sidebar-widget popular-post-widget">
										<div class="popular-post-list">
											<div class="single-post-list d-flex flex-row align-items-center">
												<div class="thumb">
													<a href="#"><img class="img-fluid" src="img/rec-3.jpg" alt=""></a>
												</div>
												<div class="details rec-price">
													<p>Scan Name</p>
													<p>El Borg Lap</p>
													<p>Price: <span style="text-decoration:line-through">200LE</span>  180LE</p>
												</div>
											</div>
											<div class="single-post-list d-flex flex-row align-items-center">
												<div class="thumb">
													<a href="#"><img class="img-fluid" src="img/rec-4.jpg" alt=""></a>
												</div>
												<div class="details rec-price">
													<p>Scan Name</p>
													<p>El Borg Lap</p>
									...
									<div class="card">
										<div class="card-horizontal">
											<div class="img-square-wrapper">
												<img class="" src="img/scan-1.jpg">
											</div>
											<div class="card-body" style="padding-bottom:0px;">
												<h4 class="card-title">Scan Name</h4>
												<p class="card-text mb-10">Some quick example text to build on the card title and make up the content.</p>
												<h6>Price: <span style="text-decoration:line-through">200LE</span>  180LE</h6>
											</div>
										</div>
