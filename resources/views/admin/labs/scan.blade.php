                                    ...
                                    <table class="table-striped col-sm-12"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('scan.show', $row->id) }}"  class="pd-setting-ed"><i
                                                        class="fa fa-eye"
                                                        aria-hidden="true"></i></a>
                                                    <a href="{{ route('scan.edit', $row->id) }}"  class="pd-setting-ed"><i class="fa fa-pencil-square-o"
                                                        aria-hidden="true"></i></a>
                                        <a href="#"  onclick="destroy('this scan','{{$row->id}}')" class="pd-setting-ed"><i
                                            class="fa fa-trash-o"
                                            aria-hidden="true"></i></a>
                                         <form id="delete_{{$row->id}}" action="{{ route('scan.destroy', $row->id) }}"  method="POST" style="display: none;">
									@csrf
									@method('DELETE')
                                                ...
                                                <div class="form-group data-custon-pick"
                                                    ...
                                                    <div
                                                        ...
                                                        <input type="number"
                                                            name="original_cost"
                                                            class="form-control"
                                                            placeholder="scan_original_cost">
                                                    </div>
                                                </div>
                                                <div class="form-group data-custon-pick"
                                                    style="text-align:left">
